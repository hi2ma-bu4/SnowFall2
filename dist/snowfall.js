...
// src/compiler.ts
var SnowFallCompilerError = class extends Error {
  errors;
  constructor(errors) {
...
var SnowFallCompiler = class {
   ...
   */
  compile(source, options = { debugInfo: false }) {
    const result = this.wasm.compile(source, options);
...
var SnowFall = class {
  ...
  getCompiler() {
    const wasm2 = this.ensureInitialized();
    return new SnowFallCompiler(wasm2);
  }
};
export {
  SnowFall,
  SnowFallCompiler,
  SnowFallCompilerError
};
