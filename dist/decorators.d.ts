 ...
 */
export declare abstract class MethodDecoratorProcessor implements ICompilerDecorator {
 ...
 */
export declare class OverrideDecorator extends MethodDecoratorProcessor {
